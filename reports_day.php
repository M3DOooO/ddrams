...
<!-- left menu ends -->
  ...
  $Year	= 	$Ryear;
			...
			<a href="reports.php"><span>التقارير</span></a> / <span>تقارير يوم <?php echo $Year?>-<?php echo $this_month?>-<?php echo $today?></span> 
			</div>
			
			<!-- content starts -->
			<center><h2><?php echo $lang_261;?></h2><?php echo $lang_262;?> <?php echo $Year?>/<?php echo $this_month?>/<?php echo $today?></br></br>
						<form action="reports_day.php" method="GET">
...
<div class="row-fluid span" style="width:50%;">
				<a data-rel="tooltip" style="width:35%;" title="<?php echo $lang_272;?>" class="well span3 top-blockk" href="reports_day_receipts.php?day=<?php echo $today ?>&&month=<?php echo $this_month ?>&&year=<?php echo $Year;?>">
				...
				<a data-rel="tooltip"  style="width:35%;" title="<?php echo $lang_265;?>" class="well span3 top-blockk" href="reports_day_takeaway.php?day=<?php echo $today ?>&&month=<?php echo $this_month ?>&&year=<?php echo $Year;?>">
					<span><img src="img/app/reports/report.png" height="35" /></span>
					<div><?php echo $lang_266;?></div>
 					<span class="notification"><?php echo $lang_126;?></span>
				</a>

				<a data-rel="tooltip"  style="width:35%;" title="<?php echo $lang_267;?>" class="well span3 top-blockk" href="reports_day_products.php?day=<?php echo $today ?>&&month=<?php echo $this_month ?>&&year=<?php echo $Year;?>">
				...
				<a data-rel="tooltip"  style="width:35%;" title="<?php echo $lang_269;?>" class="well span3 top-blockk" href="reports_day_out.php?day=<?php echo $today ?>&&month=<?php echo $this_month ?>&&year=<?php echo $Year;?>">
				...
				<a data-rel="tooltip"  style="width:35%;" title="<?php echo $lang_105;?>" class="well span3 top-blockk" href="reports_day_discounts.php?day=<?php echo $today ?>&&month=<?php echo $this_month ?>&&year=<?php echo $Year;?>">
					<span><img src="img/app/reports/dis.png" height="35" /></span>
					<div><?php echo $lang_105;?></div>
 					<span class="notification red"><?php echo $lang_126;?></span>
				</a>
				<a data-rel="tooltip"  style="width:35%;" title="<?php echo $lang_273;?>" class="well span3 top-blockk" href="reports_day_in.php?day=<?php echo $today ?>&&month=<?php echo $this_month ?>&&year=<?php echo $Year;?>">
				...
				<a data-rel="tooltip" style="width:35%;" title="<?php echo $lang_46;?>" class="well span3 top-blockk" href="reports_day_casheer.php?day=<?php echo $today ?>&&month=<?php echo $this_month ?>&&year=<?php echo $Year;?>">
					<span><img src="img/app/reports/casheers.png" height="35" /></span>
					<div><?php echo $lang_46;?></div>
 					<span class="notification green"><?php echo $lang_126;?></span>
				</a>
				<a data-rel="tooltip" style="width:35%;" title="<?php echo $lang_270;?>" class="well span3 top-blockk" href="reports_day_shift.php?day=<?php echo $today ?>&&month=<?php echo $this_month ?>&&year=<?php echo $Year;?>">
...
mysql_connect("$host", "$user", "$pass")or die("cannot connect");
mysql_select_db("$db")or die("cannot select DB");		 	
$query = "SELECT  SUM(money) FROM reports where day = $today AND month = $this_month AND year = $Year  AND status = 'done'"; 
$resulty = mysql_query($query) or die(mysql_error());
// Print out result
while($row = mysql_fetch_array($resulty)){
$one = $row['SUM(money)'];
}
$query = "SELECT  SUM(discount2) FROM reports where day = $today AND month = $this_month AND year = $Year AND status = 'done'"; 
$resulty = mysql_query($query) or die(mysql_error());
// Print out result
while($row = mysql_fetch_array($resulty)){
$ds2 = $row['SUM(discount2)'];
} 
$query = "SELECT  SUM(discount_amount) FROM reports where day = $today AND month = $this_month AND year = $Year AND status = 'done'"; 
$resulty = mysql_query($query) or die(mysql_error());
// Print out result
while($row = mysql_fetch_array($resulty)){
$ds3 = $row['SUM(discount_amount)'];
 ...
 $query = "SELECT  SUM(discount2) FROM reports2 where day = $today AND month = $this_month AND year = $Year AND status ='done'"; 
$resulty = mysql_query($query) or die(mysql_error());
// Print out result
while($row = mysql_fetch_array($resulty)){
...
mysql_select_db("$db")or die("cannot select DB");
			...
			$query = "SELECT  SUM(price) FROM reports2 where day = $today AND month = $this_month AND year = $Year AND notes = 'order' AND status = 'done'"; 
...
while($row = mysql_fetch_array($resulty)){
 ...
 $query = "SELECT  SUM(price) FROM reports2 where day = $today AND month = $this_month AND year = $Year AND catagory = 'exp' AND status ='done'"; 
...
while($row = mysql_fetch_array($resulty)){
	...
	//echo "<h2>Today Expenses: <font color='green'>". $row['SUM(price)'];   
	 ...
	 $query = "SELECT  SUM(price) FROM reports2 where day = $today AND month = $this_month AND year = $Year AND catagory = 'in' AND status ='done'"; 
